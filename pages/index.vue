<template>
    <section>
        ...
        <div id="shadow"></div>
        <div class="cc">
            <svg version="1.1" id="alpacio_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1870.61 1592.878" xml:space="preserve">
                <g>
  ...
  export default {
    ...
    head() {
      return {
        title: this.title,
        meta: [
          { hid: 'description', name: 'description', content: 'Alpac.io personal website' },
        ],
      };
    },
  };
